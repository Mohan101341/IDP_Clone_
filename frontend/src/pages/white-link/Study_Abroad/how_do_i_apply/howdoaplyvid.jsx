...
import "./HowDoApplyVid.css";
function HowDoApplyVid() {
  return (
    <div className="hdap">
      <div>
        <p>
        ...
        <h2>Ways to apply to foreign universities</h2>
        <p>
        ...
        <h2>Apply with an education counsellor</h2>
        <p>
