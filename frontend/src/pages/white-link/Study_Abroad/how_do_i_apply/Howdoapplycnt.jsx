    ...
    <div>
      ...
      <section className="apply-section apply-section-steps">
        ...
        <ul>
          ...
          <li>
            <strong>Register for IELTS:</strong> IELTS is a key part of your application, with most students needing to take IELTS Academic. This standardised test assesses your english proficiency in an academic setting to help universities ensure you have the language skills required for your nominated course.
            <br />
          ...
          <li>
            <strong>Prepare Essays and Statement of Purpose:</strong> Your essays and statement of purpose are key—they show who you are, why you want to study, and what your goals are. This is your chance to share your passion, connect your goals with the program, and highlight your unique experiences.
            <br />
          ...
          <li>
            <strong>Arrange Your Transcripts Early:</strong> Request official transcripts from all the colleges or universities you have attended. These are essential for showing your academic history and fit for the program.
            <br />
          ...
          <li>
            <strong>Check Financial Aspects & Apply for Scholarships:</strong> It’s important to have enough money to cover not just tuition fees, but also accommodation, food, transport, health insurance, and more. Many universities require proof of financial ability during admission to ensure international students can afford their studies.
            <br />
          ...
          <li>
            <strong>Apply Online:</strong> Many universities now have online application processes which makes sending your materials easier. Each university typically has an application portal through their official websites that can be easily found online.
            <br />
      ...
      {/* Section 2: Country-specific Application Processes */}
      <section className="apply-section apply-section-country">
        <h2>Different foreign university application processes</h2>
        <p>
        ...
        <p>Let’s go over the application steps for some popular study destinations.</p>

        <h3>Applying to Australian Universities</h3>
        <p>
        ...
        <h3>Applying to UK Universities</h3>
        <p>
        ...
        <h3>Applying to USA Universities</h3>
        <p>
        ...
        <h3>Applying to New Zealand Universities</h3>
        <p>
        ...
        <h3>Applying to Ireland Universities</h3>
        <p>
