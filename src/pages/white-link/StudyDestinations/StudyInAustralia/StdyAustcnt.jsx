...
<div className="study-australia">
  <h1>Here’s a comprehensive guide for all Indian students who want to study in Australia</h1>
  ...
  <div className="content">
    <p>
      We know you have a lot of questions in your mind, so we’ve answered common questions students like you raise about studying and living in Australia.
    </p>
    ...
    <p>
      Australia is not about theoretical studies; it’s all about getting you real-world-ready. From internships to networking with global pros and pioneering research, it’s the place to kickstart your career. Plus, with a buzzing job market and solid support for Indian students, you're setting yourself up for major success. Ready to boost your future? Australia’s got you.
    </p>

    <h2>Benefits of Studying in Australia</h2>

    <div className="benefit">
      <h3>World-Class Cities for Students</h3>
      <p>
        According to the QS Best Student Cities 2025, Australian cities like Melbourne, Sydney, Brisbane, Canberra, and Adelaide are ranked among the top 30 globally for their blend of student mix, desirability, employer activity, and more.
      </p>
    </div>
