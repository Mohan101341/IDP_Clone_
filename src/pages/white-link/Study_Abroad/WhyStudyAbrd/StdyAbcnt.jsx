...
function StdyAbcnt() {
  return (
    <div className="stdyabcnt-container">
      <p>
        A global perspective will make you a stronger applicant for grad school or future jobs. Your time abroad also shows you value international learning and can adapt to new environments.
      </p>

      <h2>Grow your career opportunities</h2>
      <p>
